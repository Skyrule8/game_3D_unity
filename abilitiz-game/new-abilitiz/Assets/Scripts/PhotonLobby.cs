...
public class PhotonLobby : MonoBehaviourPunCallbacks
{
   ...
   void Update(){
       ...
       txtNumPlayers.text="Number of Players: "+numPlayers.ToString()+"/6"; //20 because we are on the free tier
   }
   ...
   void CreateRoom(){
       ...
       RoomOptions roomOps = new RoomOptions(){IsVisible=true,IsOpen=true,MaxPlayers=5}; //all of our players in the same room, if we want multiple rooms, make MaxPlayers to a small number
